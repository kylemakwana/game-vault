...
@pytest.mark.parametrize(
    ("category", "expected"),
    [
        ("ps5_native_game", PlayStationPlatformEnum.PS5),
        ("ps4_game", PlayStationPlatformEnum.PS4),
        ("unknown", PlayStationPlatformEnum.UNKNOWN),
        ("ps3_game", PlayStationPlatformEnum.UNKNOWN),
    ],
)
